...
import { Grid, Form, Button, Divider, Icon } from 'semantic-ui-react'
...
export default function JobAdvertisementAdd() {
    ...
    useEffect(() => {
        ...
        positionService.getPositionsByEmployerId(2).then(results => setPositions(results.data.data));
    }, []);
    ...
    const formik = useFormik({
        initialValues: {
            ...
            city: '', workStyle: '',
            minSalary: '', maxSalary: '',
            positionCount: '', lastApplyDate: '', jobTimeName: ''
        },
